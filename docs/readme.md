# FlareFilter
FlareFilter is an intelligent, edge-native IP reputation and automated blocking system built specifically for the Cloudflare ecosystem. It monitors traffic patterns in real-time, identifies high-velocity threats, and synchronizes blocklists across the global edge using Cloudflare Workers, D1, and KV.
...
### Cloudflare D1: A SQLite database that stores historical attack data, allowing for trend analysis and persistent reputation scoring. Drizzle ORM
...
### Next.js: A sleek dashboard to visualize attacks, manage thresholds, and manually override blocks.
...
- Automated Rate Detection: Catch "low and slow" or "burst" attacks that standard WAF rules might miss.
...
- Admin Dashboard: Real-time visualization of blocked threats and manual "VIP" allow-listing.