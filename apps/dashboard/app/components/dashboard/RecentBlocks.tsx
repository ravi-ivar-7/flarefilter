    ...
    return (
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden flex flex-col">
            <div className="px-6 py-4 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center">
                ...
                <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-rose-500/10 border border-rose-200/50 text-rose-600 text-[10px] font-black uppercase tracking-widest animate-pulse">
            ...
            <div className="p-5 space-y-4">
                {attacks.length === 0 ? (
                    ...
                    attacks.map((attack) => (
                        <div key={attack.id} className="p-4 rounded-xl border border-rose-100 bg-gradient-to-br from-white to-rose-50/30">
