...
export function Profile({ user, activeOrg, orgs }: { user: any; activeOrg: any; orgs: any[] }) {
    ...
    return (
        <div className="flex flex-col gap-6">
            {/* Minimalist Header */}
            <header className="sticky top-16 z-20 bg-white/95 backdrop-blur-md border-b border-slate-200/60 px-4 py-3 flex flex-wrap items-center justify-between w-full gap-3">
